    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fund_manager_id', models.CharField(default='', max_length=200, verbose_name='基金经理id')),
                ('fund_company_id', models.CharField(default='', max_length=200, verbose_name='基金公司id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manager_id', models.CharField(max_length=20, unique=True, verbose_name='基金经理id')),
                ('company_id', models.CharField(default='', max_length=20, verbose_name='所属公司id')),
                ('working_time', models.IntegerField(default=0, verbose_name='从业时间')),
                ('total_asset_manage_amount', models.FloatField(default=0, verbose_name='基金资产管理总规模')),
